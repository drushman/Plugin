...
/**
 * @file
 * Contains \Drupal\plugin\Component\Utility\UrlHelper.
 */
...
class UrlHelper {
   ...
   *   e.g. \Drupal\plugin::request()->query->all().
   * @param string $parent
  ...
  /**
   * Encodes a Drupal\plugin path for use in a URL.
   *
   * For aesthetic reasons slashes are not escaped.
   *
   * @param string $path
   *   The Drupal\plugin path to encode.
   *
   * @return string
   *   The encoded path.
   */
  ...
  /**
   * Returns whether a path is external to Drupal\plugin (e.g. http://example.com).
   *
   * If a path cannot be assessed by Drupal\plugin's menu handler, then we must
   ...
   * check_url() or Drupal\plugin\Component\Utility\Xss::filter(), but those functions
   ...
   * Drupal\plugin\Core\Template\Attribute, or another function that will call
   * \Drupal\plugin\Component\Utility\String::checkPlain() separately.
   *
   * @param string $uri
   ...
   * Drupal\plugin menu paths, which can contain arbitrary characters.
