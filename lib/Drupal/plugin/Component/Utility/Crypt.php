...
/**
 * @file
 * Contains \Drupal\plugin\Component\Utility\Crypt.
 */
...
class Crypt {
  ...
  public static function randomBytes($count) {
    // $random_state does not use Drupal\plugin_static as it stores random bytes.
  ...
  public static function hmacBase64($data, $key) {
    ...
    if (!is_scalar($data) || !is_scalar($key)) {
      throw new \InvalidArgumentException('Both parameters passed to \Drupal\plugin\Component\Utility\Crypt::hmacBase64 must be scalar values.');
    }
   ...
   *
   * @see \Drupal\plugin\Component\Utility\Crypt::randomBytes()
   */
