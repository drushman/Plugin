...
/**
 * @file
 * Contains Drupal\plugin\Component\Utility\Export.
 */
...
class Variable {
  ...
  /**
   * Drupal\plugin-friendly var_export().
   *
   * @param mixed $var
   ...
   *
   * @return string
   *   The variable exported in a way compatible to Drupal\plugin's coding standards.
   */
