...
/**
 * @file
 * Contains \Drupal\plugin\Component\Utility\Number.
 */
...
class Number {
   ...
   *
   * @see \Drupal\plugin\Component\Utility\Number::alphadecimalToInt
   */
   ...
   *   The integer value.
   *
   * @see \Drupal\plugin\Component\Utility\Number::intToAlphadecimal
   */
