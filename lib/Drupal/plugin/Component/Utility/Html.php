...
/**
 * @file
 * Contains \Drupal\plugin\Component\Utility\Html.
 */
...
class Html {
   ...
   *
   * Use \Drupal\plugin\Component\Utility\Html::serialize() to serialize this
...
EOD;
   ...
   *
   * \DOMDocument::loadHTML() in \Drupal\plugin\Component\Utility\Html::load() makes
