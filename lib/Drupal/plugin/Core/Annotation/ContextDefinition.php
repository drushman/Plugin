...
/**
 * @file
 * Contains \Drupal\plugin\Core\Annotation\ContextDefinition.
 */
...
class ContextDefinition extends Plugin {
  ...
  public function __construct(array $values) {
    ...
    if (isset($values['class']) && !in_array('Drupal\plugin\Core\Plugin\Context\ContextDefinitionInterface', class_implements($values['class']))) {
      throw new \Exception('ContextDefinition class must implement \Drupal\plugin\Core\Plugin\Context\ContextDefinitionInterface.');
    }
    $class = isset($values['class']) ? $values['class'] : 'Drupal\plugin\Core\Plugin\Context\ContextDefinition';
   ...
   *
   * @return \Drupal\plugin\Core\Plugin\Context\ContextDefinitionInterface
   */
  public function get() {
