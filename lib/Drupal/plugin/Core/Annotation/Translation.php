...
/**
 * @file
 * Definition of Drupal\plugin\Core\Annotation\Translation.
 */

namespace Drupal\plugin\Core\Annotation;

use Drupal\plugin\Component\Annotation\AnnotationBase;
use Drupal\plugin\Core\StringTranslation\TranslationWrapper;
...
class Translation extends AnnotationBase {
   ...
   *
   * @var \Drupal\plugin\Core\StringTranslation\TranslationWrapper
   */
   ...
   *
   * Parses values passed into this class through the t() function in Drupal\plugin and
